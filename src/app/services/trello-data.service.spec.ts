...
describe('TrelloDataService', () => {
  ...
  describe('getRequestUri', () => {
    it('should return the Trello API URI formulated with the provided short link', () => {
      const actual = service.getRequestUri(HistoryMock.MOCK_SHORT_LINK);
      const expected = `https://trello.com/1/cards/${HistoryMock.MOCK_SHORT_LINK}/actions?filter=createCard,convertToCardFromCheckItem,updateCard&limit=1000`;
